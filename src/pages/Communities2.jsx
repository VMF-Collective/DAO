...
export default function Communities2(){
  ...
  useEffect(() => {
    ...
    const getCommunities = async () => {
      ...
      setCommunities(communitiesFromServer.docs.map((doc) => ({...doc.data(), id: doc.id})));
    };
      ...
      <div className="card blog-post border-0 rounded overflow-hidden shadow">
        ...
        <div className="col-12">
          <ul className="pagination justify-content-center mb-0">
            <li className="page-item"><a className="page-link" href="" aria-label="Previous">Previous</a></li>
